...
{
    public partial class Trend_R1 : Form
    {
        ...
        public Trend_R1()
        {
            ...
            chart4.MouseClick += Chart4_MouseClick;
        ...
        private void InitializeChart()
        {
            ...
            chart4.Series.Clear();
            chart4.Series.Add(temperatureSeries);
            ...
            chart4.Series.Add(fixedLineSeries);

            // Cursor settings
            chart4.Cursor = Cursors.Cross;
        ...
        {
            var hitTestResult = chart4.HitTest(e.X, e.Y);
        ...
        private void Chart4_MouseMove(object sender, MouseEventArgs e)
        {
            ...
            if (hitTestResult.ChartElementType == ChartElementType.DataPoint)
            {
                ...
                var series = chart4.Series[hitTestResult.Series.Name];
                ...
                toolTip.SetToolTip(chart4, tooltipText);
            }
        }
        ...
        private void UpdateChartData()
        {
            ...
            string query = "SELECT TEMP_R1, Cur_timestamp FROM Rector1 ORDER BY Cur_timestamp";
            ...
            using (OdbcConnection connection = new OdbcConnection(connectionString))
            {
                ...
                foreach (DataRow row in dataTable.Rows)
                {
                    ...
                    double temperature = Convert.ToDouble(row["TEMP_R1"]);
                    ...
                    chart4.Series["Temperature"].Points.AddXY(timestamp, temperature);
                }
        ...
        private void ReloadChartFromCurrentTime()
        {
            ...
            DateTime now = DateTime.Now;
            ChartArea chartArea = chart4.ChartAreas["TemperatureChartArea"];
        ...
        private void Trend_R1_Load(object sender, EventArgs e)
        {
