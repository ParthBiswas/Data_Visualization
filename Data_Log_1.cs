...
{
    public partial class Data_Log_1 : Form
    {
        ...
        private void load_part(DateTime? startDate = null, DateTime? endDate = null)
        {
            ...
            string query = "SELECT * FROM Rector1";
            if (startDate.HasValue && endDate.HasValue)
            {
                query += " WHERE Rector1 BETWEEN ? AND ?";
            }
        ...
        private void Data_Log_1_Load(object sender, EventArgs e)
        {
            //// TODO: This line of code loads data into the 'wOWDataSet.report' table. You can move, or remove it, as needed.
            //this.rector1TableAdapter.Fill(this.wOWDataSet4.Rector1);
